...
from models.nn.blocks import (DoubleConv_v1, DoubleConv_v3_1)
from models.nn.blocks import MLP
...
@HEADS.register(name="InstDoubleConv")
...
@HEADS.register(name="InstStackedConv")
class InstanceBranch(nn.Module):
    def __init__(self, in_channels, out_channels=256, num_convs=4):
        super().__init__()
