...
# coat_settings = {
#     # 'B': [[3, 6, 10, 8], [128, 256, 320, 512], 0.1],  # [depths, dims, dpr]
#     'B': [[152, 320, 320, 320, 320], ]
# }

class CoaT(nn.Module):
    """ CoaT class. """

    def __init__(self, model_name: str = 'T', patch_size=4, in_chans=3, embed_dims=[0, 0, 0, 0],
        ...
        # assert model_name in coat_settings.keys(), \
        #     f"ConvNeXt model name should be in {list(coat_settings.keys())}"
        # depths, embed_dims, drop_path_rate = coat_settings[model_name]
