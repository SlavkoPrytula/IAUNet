        ...
        def go_up(x):
            ...
            for i in range(self.n_levels):
                ...
                if i == self.n_levels - 1:
                    ...
                    # occl_feats = self.out_occluder_branch[0](occl_feats)  # (464, H, W) -> (256, H, W)
                    # occl_feats = self.out_occluder_branch[1](occl_feats)  # (256, H, W) -> (256, H, W)
                    ...
                    # inst_feats = self.out_instance_branch[0](inst_feats)  # (464, H, W) -> (256, H, W)
                    # # inst_feats = inst_feats + occl_feats # (256, H, W)
                    # inst_feats = self.out_instance_branch[1](inst_feats)    # (256, H, W) -> (256, H, W)
