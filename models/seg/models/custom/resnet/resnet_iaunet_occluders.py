...
@MODELS.register(name="resnet_iaunet_occluders")
class IAUNet(nn.Module):
    ...
    def forward(self, x, idx=None):
        ...
        occluder_masks = nn.UpsamplingBilinear2d(scale_factor=2)(occluder_masks)
        overlap_masks = nn.UpsamplingBilinear2d(scale_factor=2)(overlap_masks)
