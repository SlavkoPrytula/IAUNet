...
class IAUNet(nn.Module):
    def __init__(
        ...
        for i in range(self.n_levels):
            self.instance_head.append(HEADS.build(cfg.model.instance_head))
    ...
    def forward(self, x, idx=None):
        ...
        inst_masks = nn.UpsamplingBilinear2d(size=cfg.train.size)(inst_masks)
        iam = nn.UpsamplingBilinear2d(size=cfg.train.size)(iam)
