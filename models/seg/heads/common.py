...
# def _make_stack_3x3_convs(num_convs, in_channels, out_channels, hidden_dims=128):
#     convs = []
#     current_channels = in_channels

#     for i in range(num_convs):
#         next_channels = hidden_dims if i < num_convs - 1 else out_channels
        
#         convs.append(nn.Conv2d(current_channels, next_channels, 3, padding=1))
#         convs.append(nn.BatchNorm2d(next_channels))
#         convs.append(nn.ReLU(inplace=True))
...
# def _make_stack_3x3_convs(num_convs, in_channels, out_channels, version="v1"):
#     convs = []
#     for i in range(num_convs):
#         _out_channels = out_channels if (version == "v2" and i == num_convs - 1) else in_channels
#         convs.extend([
#             nn.Conv2d(in_channels, _out_channels, 3, padding=1),
