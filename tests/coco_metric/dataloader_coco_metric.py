...
if __name__ == "__main__":
    from dataset.datasets import HuBMAP, LiveCell30Images, YeastNet, Rectangle, BrightfieldCOCO
    from configs.datasets import HuBMAP, LiveCell30Images, YeastNet, Rectangle, BrightfieldCOCO_v2
