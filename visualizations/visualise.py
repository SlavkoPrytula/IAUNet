...
def visualize_grid_v2(figsize=(10, 10), masks=None, bboxes=None, titles=None, 
    ...
    Args:
        ...
        masks (np.ndarray): Binary mask array of shape (N, H, W).
        bboxes (np.ndarray or list, optional): Bounding boxes for each mask, shape (N, 4) in cxcywh format.
        titles (list, optional): Titles for each subplot.
        ncols (int): Number of columns in the grid.
        nrows (int, optional): Number of rows in the grid.
        path (str): Path where the figure is saved.
        **params: Additional parameters for plt.imshow.
