...
def run(cfg: _cfg):
    ...
    # TODO: 2config : Visualization {n_samples: int = 5}
...
if __name__ == '__main__':
    ...
    experiment_path = Path("runs/[iaunet]/[brightfield_coco_v2.0]/[softmax_iam]/[kernel_dim=256]-[multi_level=True]-[coord_conv=True]-[losses=['labels', 'masks']]/[job=50319589]-[2024-02-09 19:21:55]")
