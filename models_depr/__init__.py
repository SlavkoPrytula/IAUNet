...
def save_model_files(model_cfg, save_dir):
    ...
    copy_tasks = [
        ...
        (join(MODEL_FILES, "matcher.py"), model_save_dir, MODEL_FILES),
        (join(MODEL_FILES, "loss.py"), model_save_dir, MODEL_FILES),
        (join(MODEL_FILES, "heads"), model_save_dir, MODEL_FILES),
        (join(MODEL_FILES, "models/__init__.py"), model_save_dir, MODEL_FILES),
