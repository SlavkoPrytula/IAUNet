...
#     SparseSEUnet,
#     SparseSEUnetAddOverlaps,
#     SparseSEUnetOccluder, 
#     SparseSEUnetOccluderOverlap, 
#     SparseSEUnetOccluderGCN,
#     SparseSEUnetOccluderGCNMultiHeaded, 
#     SparseSEUnetOccluderMultiLevel, 
#     SparseSEUnetOccluderMultiHeaded,
#     SparseSEUnetMultiLevelIAM, 
#     SparseSEUnetSimplified,
#     )
from models.seg import *
from configs import cfg, MODEL_FILES, CONFIG_FILES
...
def get_model(cfg: cfg):
    ...
    if cfg.model.load_from_files:
        ...
        #     'sparse_seunet_occluder': SparseSEUnetOccluder,
        #     'sparse_seunet_occluder_overlap': SparseSEUnetOccluderOverlap,
        #     'sparse_seunet_occluder_gcn_sh': SparseSEUnetOccluderGCN,
        #     'sparse_seunet_occluder_gcn_mh': SparseSEUnetOccluderGCNMultiHeaded,
        #     'sparse_seunet_occluder_ml': SparseSEUnetOccluderMultiLevel,
        #     'sparse_seunet_occluder_mh': SparseSEUnetOccluderMultiHeaded,
        #     'sparse_seunet_ml_iam': SparseSEUnetMultiLevelIAM,    
        #     'sparse_seunet_simplified': SparseSEUnetSimplified,
        # }
