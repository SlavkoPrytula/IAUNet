...
cswin_settings = {
    'T': [64, [1, 2, 21, 1], [2, 4, 8, 16]],  # [embed_dims, depths, heads]
...
class CSWin(nn.Module):
    ...
    """
    def __init__(self, model_name: str = 'B', img_size=224, patch_size=4, in_chans=3,
                 split_size=[1, 2, 7, 7], mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, use_chk=False):
        super().__init__()
        embed_dims, depth, num_heads = cswin_settings[model_name]
        self.num_features = embed_dims  # num_features for consistency with other models
