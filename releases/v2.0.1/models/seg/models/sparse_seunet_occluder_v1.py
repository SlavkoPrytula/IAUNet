...
from ..heads.instance_head import InstanceBranch, PriorInstanceBranch, GroupInstanceBranch, DoubleIAMBranch, InstanceIAMFusionBranch
...
class SparseSEUnet(BaseModel):
    def __init__(
        ...
        self.instance_branch = InstanceIAMFusionBranch(
            dim=256, 
            kernel_dim=self.kernel_dim, 
            num_masks=self.num_masks
            )
        ...
        for modules in [self.up_conv_layers_occluders, self.up_se_blocks_occluders]:
