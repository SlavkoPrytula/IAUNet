...
class SparseSEUnet(BaseModel):
    def __init__(
        ...
        for i in range(self.n_levels):
            if i == 0:
                self.mask_branch.append(MaskBranch(208, num_convs=6))
            else:
                self.mask_branch.append(MaskBranch(208+128, num_convs=6))
        ...
        for i in range(self.n_levels):
            if i == 0:
                self.mask_branch_occluder.append(MaskBranch(208, num_convs=6))
            else:
                self.mask_branch_occluder.append(MaskBranch(208+128, num_convs=6))
