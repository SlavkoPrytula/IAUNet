...
def train_one_epoch(
    ...
    for step, batch in enumerate(dataloader):
        ...
        with amp.autocast(enabled=True):
            ...
            # get losses
            loss_dict, (src_idx, tgt_idx) = criterion(output, targets, [512, 512], 
    ...
    if epoch % 10 == 0:
        ...
        for inst in ["occluders"]:
            vis_preds = output[f'pred_{inst}'].sigmoid().cpu().detach().numpy()
            # vis_logits = output[f'pred_{inst}_logits'].sigmoid().cpu().detach().numpy()
